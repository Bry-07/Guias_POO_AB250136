...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4 col-sm-offset-4">
      <c:catch var="error01">
        <%
          //intenta convertir a numero el parametro recibido en solicitud
      ...
      <form role="form">
        <input type="hidden" name="parametro" value="esto no es numero"/>
        <input type="submit" class="btn btn-info" value="Enviar valor no numerico "/>
      </form>
      <form role="form">
      ...
      <form role="form">
        <input type="submit" class="btn btn-info" value="No enviar el parametro"/>
      </form>
    </div>
  </div>
</div>
