...
<sql:query var="q1" dataSource="jdbc/mariadb">
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-danger" onclick="alerta('${persona.id_persona}')" >Eliminar</button>
      </td>
      <td>
        <a class="btn bg-primary"
           href="controller.jsp?operacion=modificar&id=${persona.id_persona}">
          Modificar</a>
        </form>
      </td>
    </tr>
